<article class="row">
    ...
    <div class="col-md-10">
        ...
        <form class="form-horizontal" method="post" action="<?php echo base_url() ?>pedido">
            ...
            <div class="form-group">
                <label for="tipoCliente" class="col-sm-4 control-label">Tipo de Cliente:</label>
                <div class="col-sm-6">
            ...
            <div class="form-group" >
                <label for="CondPago" class="col-sm-4 control-label">Cond. Pago:</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="LimiteCredito" class="col-sm-4 control-label">Limite Credito:</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="CreditoDisponible" class="col-sm-4 control-label">Credito Disponible:</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="DiasPromPago" class="col-sm-4 control-label">Dias Prom. Pago:</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="ChequesDevueltos" class="col-sm-4 control-label">Cheques Devueltos:</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="SaldoActual" class="col-sm-4 control-label">Saldo actual:</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="DigitoVerificador" class="col-sm-4 control-label">Dígito Verificador BMX y BBVA:</label>
                <div class="col-sm-6">
                    <input type="text" id="DigitoVerificador" name="DigitoVerificador" value="<?php echo $digito_verificador; ?>" class="form-control" tabindex="15" readonly/>
                </div>
            </div>

            <div class="form-group">
                <label for="DigitoVerificador2" class="col-sm-4 control-label">Dígito Verificador HSBC:</label>
                <div class="col-sm-6">
                    <input type="text" id="DigitoVerificador2" name="DigitoVerificador2" value="<?php echo $digito_verificador2; ?>" class="form-control" tabindex="15" readonly/>
                </div>
            </div>


            <div class="form-group">
                <button  type="submit" id="btnPedido" class="col-sm-offset-4 btn btn-warning " tabindex="16">
